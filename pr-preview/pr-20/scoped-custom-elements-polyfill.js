      ...
      var I = function (b) {
            ...
            a: {
              ...
              if (!(d === document || d instanceof ShadowRoot)) {
                ...
                d === document ||
                  ...
                  (d =
                    (null == (e = G.get(d)) ? void 0 : e.getRootNode()) ||
                    document);
              }
              e = d.customElements;
            }
          ...
          c.prototype.disconnectedCallback = function () {
            ...
            a
              ...
              : E.get(this).m(this, b, !1);
          };
          c.prototype.adoptedCallback = function () {
            var a, d;
            null == (a = D.get(this)) ||
              null == (d = a.adoptedCallback) ||
          ...
          c.prototype.formAssociatedCallback = function () {
            ...
            if (a && a.formAssociated) {
              var d;
              null == a ||
                null == (d = a.formAssociatedCallback) ||
                d.apply(this, arguments);
            }
          };
          ...
          c.prototype.formStateRestoreCallback = function () {
            ...
            if (null == a ? 0 : a.formAssociated) {
              var d;
              null == a ||
                null == (d = a.formStateRestoreCallback) ||
                d.apply(this, arguments);
            }
          };
          return c;
        ...
        M = function (b) {
          ...
          if (c !== window.HTMLElement)
            return c === y
              ? Object.setPrototypeOf(b, window.HTMLElement)
              : M(c);
        },
        J = function (b, c, a) {
          a = void 0 === a ? !1 : a;
        ...
        methods.forEach(function (b) {
          ...
          c[b] = function (d) {
            for (var e = [], g = 0; g < arguments.length; ++g)
              e[g] = arguments[g];
            g = Q.get(this);
            if (!0 === D.get(g).formAssociated)
              return null == a ? void 0 : a.call.apply(a, [this].concat(m(e)));
            throw new DOMException(
              'Failed to execute ' +
                a +
