...
class BayTemplatePlugin extends ScopedElementsMixin(i) {
    constructor() {
        super(...arguments);
    ...
    render() {
        return b `<h1>Bay Template Editor</h1>`;
    }
}
BayTemplatePlugin.scopedElements = {
// Scoped elements will be registered here
};
BayTemplatePlugin.styles = i$3 `
    :host {
      display: block;
      padding: 20px;
...
__decorate([
    n({ attribute: false })
], BayTemplatePlugin.prototype, "doc", void 0);
__decorate([
    n({ type: Number })
], BayTemplatePlugin.prototype, "editCount", void 0);

export { BayTemplatePlugin as default };
